          ...
          <div className="col-12 col-md-6">
            ...
            <AnimationContainer slideDirection="left" delay={0.2}>
              ...
              >
                <span className="text-primary">
                  Prepare for your Favourite Exams such as jamb, Neco and Weac
                  etc
                </span>{" "}
            ...
            <AnimationContainer slideDirection="left" delay={0.4}>
              <ul className="list-unstyled text-primary mt-3">
                <li className="py-1">
                  <LiaCheckCircle className="text-secondary me-2" /> Complete
                  Exam feel for your Upcoming Exam
                </li>
                <li className="py-1">
                ...
                <li className="py-1">
                  <LiaCheckCircle className="text-secondary  me-2" /> Practice
                  with over 1000+ Questions
                </li>
              </ul>
            </AnimationContainer>
