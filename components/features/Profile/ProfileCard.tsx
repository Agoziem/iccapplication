  ...
  ({ alert, setAlert }) => {
    ...
    const userDisplayData = useMemo(() => {
      ...
      return {
        ...
        initials: (user.username || user.first_name || "U")
          .charAt(0)
          .toUpperCase(),
      };
    }, [user]);
                  ...
                  <div className="my-4">
                    ...
                    <div className="mb-4">
                      ...
                      <ul className="text-muted mb-4">
                        ...
                        <li>
                          Your order history will be anonymized for our records
                        </li>
                        <li>
                          You will lose access to any unused account credits
                        </li>
        ...
        {editMode && (
          ...
          >
            <div className="modal-body">
              <ProfileForm
                setAlert={setAlert}
                setEditMode={handleCloseEditForm}
              />
            </div>
          </Modal>
        )}
