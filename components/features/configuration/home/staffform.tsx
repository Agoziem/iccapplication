...
import { FiUser, FiMail, FiPhone, FiMapPin, FiBriefcase, FiFacebook, FiInstagram, FiTwitter, FiLinkedin } from "react-icons/fi";
import ImageUploader from "@/components/custom/Imageuploader/ImageUploader";
import { useCreateStaff, useUpdateStaff } from "@/data/hooks/organization.hooks";
...
const StaffForm: React.FC<StaffFormProps> = ({
  ...
  const onSubmit = async (data: CreateStaffFormData | UpdateStaffFormData) => {
    try {
      ...
      const errorMessage =
        error instanceof Error ? error.message : "An error occurred while saving the staff member";
    ...
    <div className="container-fluid p-4">
          ...
          <div className="d-flex align-items-center justify-content-between">
            <div className="d-flex align-items-center">
              ...
              <h4 className="mb-0 fw-bold">
                {editMode ? `Edit "${watchedFirstName} ${watchedLastName}".trim()` : "Add New Staff Member"}
              </h4>
            </div>
            {onCancel && (
              <button
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="row g-4">
        ...
        <div className="col-lg-8">
                  ...
                  <Controller
                    ...
                    render={({ field }) => (
                      <input
                        {...field}
                        type="text"
                        className={`form-control ${errors.other_names ? "is-invalid" : ""}`}
                        placeholder="Enter other names"
                      />
                    )}
                  />
                  {errors.other_names && (
                    <div className="invalid-feedback">{errors.other_names.message}</div>
                  )}
                </div>
          ...
          <div className="card border-0 shadow-sm mb-4">
            <div className="card-body">
              <h6 className="card-title mb-3">Social Media Links</h6>
              
              <div className="row g-3">
                <div className="col-md-6">
                  <label htmlFor="facebooklink" className="form-label fw-medium">
                    <FiFacebook size={16} className="me-1 text-primary" />
                    Facebook
                  </label>
                  <Controller
                    name="facebooklink"
                ...
                <div className="col-md-6">
                  ...
                  {errors.instagramlink && (
                    <div className="invalid-feedback">{errors.instagramlink.message}</div>
                  )}
                </div>
                ...
                <div className="col-md-6">
                  ...
                  />
                  {errors.twitterlink && (
                    <div className="invalid-feedback">{errors.twitterlink.message}</div>
                  )}
                </div>

                <div className="col-md-6">
                  <label htmlFor="linkedinlink" className="form-label fw-medium">
                    <FiLinkedin size={16} className="me-1 text-primary" />
                    LinkedIn
                  </label>
                  <Controller
                    name="linkedinlink"
