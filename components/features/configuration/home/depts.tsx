...
const Depts = () => {
  ...
  return (
    <div className="container-fluid">
                    ...
                    <div className="row align-items-start">
                      ...
                      <div className="col-md-4 text-center mb-3 mb-md-0">
                        ...
                        <div className="text-end">
                          <div className="d-flex flex-column gap-2">
                            <button
                              className="badge bg-primary text-white border-0 px-3 py-2 text-truncate"
                            ...
                            <button
                              className="badge bg-danger-light text-danger border-0 px-3 py-2 text-truncate"
                              onClick={() =>
                                handleDeleteConfirm(departmentItem)
                              }
                      ...
                      <div className="col-md-8">
                        ...
                        <p className="text-muted mb-3">
                          ...
                          departmentItem.description.length > 150
                        ...
                        <div className="d-flex align-items-center mb-3">
                          ...
                          <div>
                            <h6 className="mb-0">
                              {departmentItem.staff_in_charge?.first_name}{" "}
                              {departmentItem.staff_in_charge?.last_name}
                            </h6>
                        ...
                        {/* Services */}
                        {departmentItem.services &&
                          departmentItem.services.length > 0 && (
                            <div className="mb-3">
                              <h6 className="fw-bold mb-2">
                                Services ({departmentItem.services.length})
                              </h6>
                              <div className="d-flex flex-wrap gap-1">
                                {departmentItem.services
                                  ...
                                  .map((service, index) => (
                                    <span
                                      key={index}
                                      className="badge bg-primary-light text-primary border small"
                                    >
                                      {service.name}
                                    </span>
                                  ))}
      ...
      {/* Pagination */}
      {depts && depts.count > pageSize && (
        <div className="row mt-4">
          <div className="col-12">
            <Pagination
              currentPage={page}
              totalPages={Math.ceil(depts.count / pageSize)}
      ...
      <Modal showmodal={showDeleteModal} toggleModal={closeModal}>
        <div className="p-3">
          ...
          <hr />
          <h5 className="text-center mb-4">{department?.name} Department</h5>
