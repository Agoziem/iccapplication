...
const ServicePage: FC = () => {
  ...
  const ServiceStatus = (service: Service): ReactElement | undefined => {
    if (
      !session ||
      !session.user ||
    ...
    <div style={{ minHeight: "100vh" }}>
      ...
      {!loadingService && service && (
        <div>
          ...
          <div
            className="card mx-auto my-4 p-4 px-5"
            style={{
              maxWidth: "650px",
            }}
          >
            <div className="d-flex flex-column justify-content-center gap-3">
              <div className="mx-auto">
                {service?.preview && service?.img_url ? (
                  <img
                    src={service.img_url}
                    alt="services"
                    width={89}
              ...
              <div>
                ...
                >
                  ...
                  {service?.category?.category || 'Unknown'} Service
                </p>
              ...
              <div style={{ width: "100%" }}>
                ...
                {service?.service_flow ? (
                  ...
                  >
                    Service flow information is not available.
                  </div>
                )}
              </div>
              ...
              <div>
                <button
                  ...
                  onClick={() => {
                    // Add service activation logic here
                  }}
