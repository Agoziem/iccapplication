...
export const ORGANIZATION_KEYS = {
  ...
  staffDetail: (staffId: number) =>
    [...ORGANIZATION_KEYS.all, "staff", "detail", staffId] as const,
  departments: (orgId: number) =>
    [...ORGANIZATION_KEYS.all, "departments", orgId] as const,
  testimonials: (orgId: number) =>
    [...ORGANIZATION_KEYS.all, "testimonials", orgId] as const,
  subscriptions: (orgId: number) =>
    [...ORGANIZATION_KEYS.all, "subscriptions", orgId] as const,
...
export const fetchOrganizations = async (): Promise<OrganizationArray> => {
  const response = await AxiosInstance.get(
    `${organizationApiendpoint}/organization/`
  );
...
export const fetchOrganization = async (
  ...
  const response = await AxiosInstance.get(
    `${organizationApiendpoint}/organization/${organizationId}/`
  );
  return response.data;
};
...
export const deleteOrganization = async (
  ...
  await AxiosInstanceWithToken.delete(
    `${organizationApiendpoint}/organization/delete/${organizationId}/`
  );
};
...
export const editTermsOfUse = async (
  organizationId: number,
  termsOfUse: string
): Promise<Organization> => {
  const response = await AxiosInstanceWithToken.put(
...
export const fetchStaff = async (
  ...
  const response = await AxiosInstance.get(
    `${organizationApiendpoint}/staff/${organizationId}/`,
    { params }
  );
  return response.data;
};
...
export const fetchStaffById = async (staffId: number): Promise<Staff> => {
  const response = await AxiosInstance.get(
    `${organizationApiendpoint}/staff/${staffId}/`
  );
  return response.data;
};
...
export const deleteStaff = async (staffId: number): Promise<void> => {
  await AxiosInstanceWithToken.delete(
    `${organizationApiendpoint}/staff/delete/${staffId}/`
  );
};
...
export const fetchDepartments = async (
  ...
  const response = await AxiosInstance.get(
    `${organizationApiendpoint}/department/${organizationId}/`,
    { params }
  );
  return response.data;
};
...
export const deleteDepartment = async (departmentId: number): Promise<void> => {
  await AxiosInstanceWithToken.delete(
    `${organizationApiendpoint}/department/delete/${departmentId}/`
  );
};
...
export const fetchTestimonials = async (
  ...
  const response = await AxiosInstance.get(
    `${organizationApiendpoint}/testimonial/${organizationId}/`,
    { params }
  );
  return response.data;
};
...
export const fetchTestimonialById = async (
  ...
  const response = await AxiosInstance.get(
    `${organizationApiendpoint}/testimonial/${testimonialId}/`
  );
  return response.data;
};
...
export const deleteTestimonial = async (
  ...
  await AxiosInstanceWithToken.delete(
    `${organizationApiendpoint}/testimonial/delete/${testimonialId}/`
  );
};
...
export const fetchSubscriptions = async (
  ...
  const response = await AxiosInstance.get(
    `${organizationApiendpoint}/subscription/${organizationId}/`,
    { params }
  );
  return response.data;
};
...
export const fetchSubscriptionById = async (
  ...
  const response = await AxiosInstance.get(
    `${organizationApiendpoint}/subscription/${subscriptionId}/`
  );
  return response.data;
};
...
export const deleteSubscription = async (
  ...
  await AxiosInstanceWithToken.delete(
    `${organizationApiendpoint}/subscription/delete/${subscriptionId}/`
  );
};

export const uploadRichTextImage = async (
  image: File
): Promise<RichTextEditorImages> => {
...
export const deleteRichTextImage = async (
  file_url: string
): Promise<SuccessResponse> => {
  const response = await AxiosInstanceWithToken.delete(
    `${organizationApiendpoint}/richtextimage/delete/`,
    {
      params: {
        file_url,
      },
...
export const fetchAllRichTextImages = async (): Promise<
  RichTextEditorImages[]
> => {
  const response = await AxiosInstance.get(
    `${organizationApiendpoint}/richtextimage/all/`
  );
  return response.data;
};
...
export const useUpdateOrganization = (): UseMutationResult<
  Organization,
  Error,
  { organizationId: number; updateData: UpdateOrganization }
> => {
  const queryClient = useQueryClient();

  return useMutation({
    mutationFn: ({ organizationId, updateData }) =>
      updateOrganization(organizationId, updateData),
...
export const useEditPrivacyPolicy = (): UseMutationResult<
  Organization,
  Error,
  { organizationId: number; privacyPolicy: string }
> => {
  const queryClient = useQueryClient();

  return useMutation({
    mutationFn: ({ organizationId, privacyPolicy }) =>
      editPrivacyPolicy(organizationId, privacyPolicy),
    onSuccess: (data, { organizationId }) => {
      queryClient.setQueryData(ORGANIZATION_KEYS.detail(organizationId), data);
      queryClient.invalidateQueries(ORGANIZATION_KEYS.lists());
    },
...
export const useEditTermsOfUse = (): UseMutationResult<
  Organization,
  Error,
  { organizationId: number; termsOfUse: string }
> => {
  const queryClient = useQueryClient();

  return useMutation({
    mutationFn: ({ organizationId, termsOfUse }) =>
      editTermsOfUse(organizationId, termsOfUse),
    onSuccess: (data, { organizationId }) => {
      queryClient.setQueryData(ORGANIZATION_KEYS.detail(organizationId), data);
      queryClient.invalidateQueries(ORGANIZATION_KEYS.lists());
    },
...
export const useStaffs = (
  organizationId: number,
  params?: Record<string, any>
): UseQueryResult<PaginatedStaff, Error> => {
  return useQuery({
...
export const useCreateStaff = (): UseMutationResult<
  Staff,
  Error,
  { organizationId: number; staffData: CreateStaff }
> => {
  const queryClient = useQueryClient();

  return useMutation({
    mutationFn: ({ organizationId, staffData }) =>
      createStaff(organizationId, staffData),
    onSuccess: (data, { organizationId }) => {
...
export const useUpdateStaff = (): UseMutationResult<
  Staff,
  Error,
  { staffId: number; updateData: UpdateStaff }
> => {
  const queryClient = useQueryClient();
  ...
  return useMutation({
    ...
    onSuccess: (data, { staffId }) => {
      ...
      queryClient.invalidateQueries(
        ORGANIZATION_KEYS.staff(data.organization || 0)
      );
    },
    onError: (error: Error) => {
...
export const useDeleteStaff = (): UseMutationResult<
  void,
  Error,
  { staffId: number; organizationId: number }
> => {
  const queryClient = useQueryClient();
...
export const useDepartments = (
  organizationId: number,
  params?: Record<string, any>
): UseQueryResult<PaginatedDepartment, Error> => {
  return useQuery({
...
export const useCreateDepartment = (): UseMutationResult<
  Department,
  Error,
  { organizationId: number; departmentData: CreateDepartment }
> => {
  const queryClient = useQueryClient();

  return useMutation({
    mutationFn: ({ organizationId, departmentData }) =>
      createDepartment(organizationId, departmentData),
    onSuccess: (data, { organizationId }) => {
      queryClient.invalidateQueries(
        ORGANIZATION_KEYS.departments(organizationId)
      );
    },
    onError: (error: Error) => {
...
export const useUpdateDepartment = (): UseMutationResult<
  Department,
  Error,
  { departmentId: number; updateData: UpdateDepartment; organizationId: number }
> => {
  const queryClient = useQueryClient();
...
export const useDeleteDepartment = (): UseMutationResult<
  void,
  Error,
  { departmentId: number; organizationId: number }
> => {
  const queryClient = useQueryClient();
...
export const useTestimonials = (
  organizationId: number,
  params?: Record<string, any>
): UseQueryResult<PaginatedTestimonial, Error> => {
  return useQuery({
...
export const useTestimonialById = (
  testimonialId: number
): UseQueryResult<Testimonial, Error> => {
  return useQuery({
    queryKey: [
      ...ORGANIZATION_KEYS.all,
      "testimonial",
      "detail",
      testimonialId,
    ],
...
export const useCreateTestimonial = (): UseMutationResult<
  Testimonial,
  Error,
  { organizationId: number; testimonialData: CreateTestimonial }
> => {
  const queryClient = useQueryClient();

  return useMutation({
    mutationFn: ({ organizationId, testimonialData }) =>
      createTestimonial(organizationId, testimonialData),
    onSuccess: (data, { organizationId }) => {
      queryClient.invalidateQueries(
        ORGANIZATION_KEYS.testimonials(organizationId)
      );
    },
    onError: (error: Error) => {
...
> => {
  ...
  return useMutation({
    mutationFn: ({ testimonialId, updateData }) =>
      updateTestimonial(testimonialId, updateData),
    onSuccess: (data, { testimonialId, organizationId }) => {
      queryClient.setQueryData(
        [...ORGANIZATION_KEYS.all, "testimonial", "detail", testimonialId],
        data
      );
      queryClient.invalidateQueries(
        ORGANIZATION_KEYS.testimonials(organizationId)
...
export const useDeleteTestimonial = (): UseMutationResult<
  void,
  Error,
  { testimonialId: number; organizationId: number }
> => {
  const queryClient = useQueryClient();
...
export const useSubscriptions = (
  organizationId: number,
  params?: Record<string, any>
): UseQueryResult<PaginatedSubscription, Error> => {
  return useQuery({
...
export const useCreateSubscription = (): UseMutationResult<
  Subscription,
  Error,
  { organizationId: number; subscriptionData: CreateSubscription }
> => {
  const queryClient = useQueryClient();

  return useMutation({
    mutationFn: ({ organizationId, subscriptionData }) =>
      createSubscription(organizationId, subscriptionData),
    onSuccess: (data, { organizationId }) => {
      queryClient.invalidateQueries(
        ORGANIZATION_KEYS.subscriptions(organizationId)
      );
    },
    onError: (error: Error) => {
...
> => {
  ...
  return useMutation({
    ...
    onSuccess: (data, { subscriptionId, organizationId }) => {
      queryClient.setQueryData(
        [...ORGANIZATION_KEYS.all, "subscription", "detail", subscriptionId],
        data
      );
      queryClient.invalidateQueries(
        ORGANIZATION_KEYS.subscriptions(organizationId)
...
export const useDeleteSubscription = (): UseMutationResult<
  void,
  Error,
  { subscriptionId: number; organizationId: number }
> => {
  const queryClient = useQueryClient();
...
export const useRichTextImages = (): UseQueryResult<
  RichTextEditorImages[],
  Error
> => {
  return useQuery({
...
export const useUploadRichTextImage = (): UseMutationResult<
  RichTextEditorImages,
  Error,
  File
> => {
...
export const useDeleteRichTextImage = (): UseMutationResult<
  SuccessResponse,
  Error,
  string
> => {
